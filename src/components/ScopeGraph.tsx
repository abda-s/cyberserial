...
import type { ScopeScrollbarHandle } from './graph/ScopeScrollbar';
...
export const ScopeGraph = forwardRef<ScopeGraphHandle, ScopeGraphProps>(({ data, options }, ref) => {
    ...
    const currentWindowSize = useRef(13);
    ...
    useImperativeHandle(ref, () => ({
        zoomIn: () => {
            ...
            if (xData && xData.length > 0) {
                ...
                // Clamp Right: Strict clamp to dataMax, UNLESS data is smaller than window
                const dataMax = xData[xData.length - 1];
